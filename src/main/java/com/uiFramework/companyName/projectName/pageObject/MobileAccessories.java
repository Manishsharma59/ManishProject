...
public class MobileAccessories {
	...
	private Logger log = LoggerHelper.getLogger(MobileAccessories.class);
	WaitHelper wait;
	...
	public MobileAccessories(WebDriver driver) throws IOException {
		this.driver = driver;
		PageFactory.initElements(driver, this);
		wait = new WaitHelper(driver);
		wait.waitForElement(search, ObjectReader.reader.getImplicitWait());
		log.info("MobileAccessories Page Object created");
