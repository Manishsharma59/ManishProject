...
public class Automotive {
	...
	private Logger log = LoggerHelper.getLogger(Automotive.class);
	WaitHelper wait;
	...
	public Automotive(WebDriver driver) throws IOException {
		this.driver = driver;
		PageFactory.initElements(driver, this);
		wait = new WaitHelper(driver);
		wait.waitForElement(search, ObjectReader.reader.getImplicitWait());
		log.info("Automotive Page Object created");
