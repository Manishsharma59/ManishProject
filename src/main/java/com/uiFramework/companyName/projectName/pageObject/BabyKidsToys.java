...
public class BabyKidsToys {
	
	private WebDriver driver;
	private Logger log = LoggerHelper.getLogger(BabyKidsToys.class);
	WaitHelper wait;
	...
	public BabyKidsToys(WebDriver driver) throws IOException {
		this.driver = driver;
		PageFactory.initElements(driver, this);
		wait = new WaitHelper(driver);
		wait.waitForElement(search, ObjectReader.reader.getImplicitWait());
		log.info("BabyKidsToys Page Object created");
