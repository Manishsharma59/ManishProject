...
public class Stationery {
	...
	private Logger log = LoggerHelper.getLogger(Stationery.class);
	WaitHelper wait;
	...
	public Stationery(WebDriver driver) throws IOException {
		this.driver = driver;
		PageFactory.initElements(driver, this);
		wait = new WaitHelper(driver);
		wait.waitForElement(search, ObjectReader.reader.getImplicitWait());
		log.info("Stationery Page Object created");
