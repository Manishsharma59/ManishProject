...
public class HomeKitchen {
	...
	private Logger log = LoggerHelper.getLogger(HomeKitchen.class);
	WaitHelper wait;
	...
	public HomeKitchen(WebDriver driver) throws IOException {
		this.driver = driver;
		PageFactory.initElements(driver, this);
		wait = new WaitHelper(driver);
		wait.waitForElement(search, ObjectReader.reader.getImplicitWait());
		log.info("HomeKitchen Page Object created");
