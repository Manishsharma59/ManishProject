...
public class CarsBikes {
	
	private WebDriver driver;
	private Logger log = LoggerHelper.getLogger(CarsBikes.class);
	WaitHelper wait;
	...
	public CarsBikes(WebDriver driver) throws IOException {
		this.driver = driver;
		PageFactory.initElements(driver, this);
		wait = new WaitHelper(driver);
		wait.waitForElement(search, ObjectReader.reader.getImplicitWait());
		log.info("CarsBikes Page Object created");
